...
/**
 * Update a linear recommendation using the given Object.
 * @param {String} id - The id of the recommendation to update.
 * @param {Object} recLin - The given linear recommendation to update.
 * @returns {Object} The updated recommendation.
 */
